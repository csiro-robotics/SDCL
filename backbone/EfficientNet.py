...
def load_pretrained_weights(
    model, model_name, weights_path=None, load_fc=True, verbose=True
):
    ...
    if load_fc:
        ...
        )  # TODO fix _fc is now classifier
...
GlobalParams.__new__.__defaults__ = (None,) * (len(GlobalParams._fields) - 1) + (
    True,
)  # include top
